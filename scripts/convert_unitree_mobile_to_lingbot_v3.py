#!/usr/bin/env python3
"""Convert the Unitree mobile-transfer LeRobot v2.1 export to LingBot v3.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("output", type=Path, help="New Unitree LingBot LeRobot v3 output directory")
    parser.add_argument(
        "--video-mode",
...
def write_metadata(
    ...
    info = {
        ...
        "robot_type": "unitree_mobile_dual_arm",
